...
public class ContactController {
    ...
    @Operation(
            summary = "Get favourite contacts",
            description = "Returns all contacts marked as favourite"
    )
    @ApiResponse(
            responseCode = "200",
            description = "Favourite contacts retrieved successfully"
    )
    @GetMapping("/favourites")
    public ResponseEntity<List<ContactResponseDTO>> getFavouriteContacts() {

        List<ContactResponseDTO> response =
                contactService.getFavouriteContacts();
    ...
    @Operation(
            summary = "Toggle favourite contact",
            description = "Marks a contact as favourite or removes it from favourites"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
